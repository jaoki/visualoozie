...
import visualoozie.xsd.workflow01.ACTION;
import visualoozie.xsd.workflow01.CASE;
import visualoozie.xsd.workflow01.DECISION;
import visualoozie.xsd.workflow01.FORK;
import visualoozie.xsd.workflow01.FORKTRANSITION;
import visualoozie.xsd.workflow01.JOIN;
import visualoozie.xsd.workflow01.KILL;
import visualoozie.xsd.workflow01.WORKFLOWAPP;

public class Workflow01Parser {
	public List<WorkflowNode> parse(String rawXml) throws JAXBException {
        XmlLoader loader = new XmlLoader();
        WORKFLOWAPP xmldoc = loader.loadWorkflow01(rawXml);
